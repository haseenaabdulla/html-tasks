                    ...
                    <div class="card-body">
                        <form method="POST" action="{{url('/update/'.$student->id)}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="mobile-number" name="mobile_number" value="{{$student->mobile_number}}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="branch_select" id="branch-select" class="form-select" value="{{$student->branch_select}}">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="permanent_address" id="permanent-address" value="{{$student->permanent_address}}"></textarea>
                            </div>
